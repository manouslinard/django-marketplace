...
DATABASES = {
    "default": {
        ...
        "HOST": os.environ.get("SQL_HOST", "localhost"),    # if no sql_host is configured -> localhost (sql_host is initialized only in docker-compose)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get("EMAIL_ACC", "user@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_KEY", "email_key")
